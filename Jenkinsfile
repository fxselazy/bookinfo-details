...
"""
    ...
    PROJECT_KEY = "fuse-bookinfo-details"
    PROJECT_NAME = "fuse-bookinfo-details"
  }
        ...
        container('jnlp') {
          ...
          script {
            ...
            scmVars = git branch: "${BRANCH_NAME}",
                          ...
                          url: 'git@github.com:fxselazy/bookinfo-details.git'
          } // End script
        } // End container
      } // End steps
    } // End stage
        ...
        container('docker') {
          script {
            ...
            docker.withRegistry('https://ghcr.io', 'github-registry') {
              ...
              docker.build('ghcr.io/fxselazy/bookinfo-details:${ENV_NAME}').push()
        ...
        steps {
            container('jnlp') {
                script {
                    ...
                    writeFile file: 'anchore_images' , text: "ghcr.io/fxselazy/bookinfo-details:${ENV_NAME}"
